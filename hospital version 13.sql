...
select waitlistId as 'Wait List ID',waitList as 'Added to WaitList Date',fsa as 'FSA Date',datediff(fsa,waitList) as 'Waitingdays',
surgeonId as 'Surgeon ID'  from Waitlistpatient;
